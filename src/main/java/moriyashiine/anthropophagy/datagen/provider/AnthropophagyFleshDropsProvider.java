...
public class AnthropophagyFleshDropsProvider extends FleshDropsProvider {
	...
	protected void configure(Output output) {
		...
		output.accept(EntityType.EVOKER, AnthropophagyItems.CORRUPT_FLESH);
		...
		output.accept(EntityType.ILLUSIONER, AnthropophagyItems.CORRUPT_FLESH);
		output.accept(EntityType.IRON_GOLEM, Items.IRON_NUGGET);
		output.accept(EntityType.MANNEQUIN, AnthropophagyItems.FLESH, AnthropophagyItems.COOKED_FLESH);
		...
		output.accept(EntityType.PILLAGER, AnthropophagyItems.FLESH, AnthropophagyItems.COOKED_FLESH);
		output.accept(EntityType.PUFFERFISH, Items.BONE_MEAL);
		output.accept(EntityType.PLAYER, AnthropophagyItems.FLESH, AnthropophagyItems.COOKED_FLESH);
		output.accept(EntityType.RABBIT, Items.RABBIT, Items.COOKED_RABBIT);
		output.accept(EntityType.RAVAGER, AnthropophagyItems.CORRUPT_FLESH);
		...
		output.accept(EntityType.VILLAGER, AnthropophagyItems.FLESH, AnthropophagyItems.COOKED_FLESH);
		output.accept(EntityType.VINDICATOR, AnthropophagyItems.FLESH, AnthropophagyItems.COOKED_FLESH);
		output.accept(EntityType.WANDERING_TRADER, AnthropophagyItems.FLESH, AnthropophagyItems.COOKED_FLESH);
		output.accept(EntityType.WITCH, AnthropophagyItems.CORRUPT_FLESH);
